...
homerange %>% 
  ...
  geom_histogram(alpha = 0.4, color = "black", fill = "tomato", bins=40)+
...
homerange %>%
  ...
  geom_histogram(aes(y = ..density..), fill ="darkgoldenrod2", alpha = 0.8, color = "black")+
  geom_density(color = "green")+
  labs(title = "Dis of log10.hra")
```
...
```{r}
homerange <- homerange %>% 
             mutate(range_category = case_when(log10.mass <= -1.25 ~ " very small",
                                              log10.mass <= 3.65 & log10.mass >= -1.25 ~ "small",
                                              log10.mass >= 3.65 & log10.mass <= 4.59 ~ "medium",
                                              log10.mass >= 4.59 & log10.mass <= 6.02 ~ "large",
                                              log10.mass >= 6.02 & log10.mass ~ "very large"))
```
